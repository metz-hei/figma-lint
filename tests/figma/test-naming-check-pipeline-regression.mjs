...
const invalid = variant("invalid", "Button2", { "bad_prop": "very-large" });
const set = {
...
if (issues.length !== 3 || !issues.every((issue) => issue.nodeId === "invalid")) {
...
console.log("ok: корректный variant завершается без issues, нарушения возвращают issues");
